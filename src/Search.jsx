...
const Search = ({ audioSources, isPlaying, setIsPlaying, currentIndex, isInputVisible, setIsInputVisible, handlePlaybackToggle }) => {
          ...
          {searchTerm ? (
            filteredSongs.map((song, index) => (
              ...
              <div className="actions">
                  <div className="icon">
                    <div>
                      {currentIndex === audioSources.indexOf(song) && isPlaying ? (
                        <i className="bx bx-pause" id="masterPlay" onClick={() => setIsPlaying(!isPlaying)}></i>
                      ) : (
                        <i className="bx bx-play" id="masterPlay" onClick={() => handlePlaybackToggle(audioSources.indexOf(song))}></i>
                      )}
                    </div>
                  </div>
                </div>
